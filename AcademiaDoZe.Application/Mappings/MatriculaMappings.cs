...
public static class MatriculaMappings
{
    ...
    public static Matricula ToEntity(this MatriculaDTO matriculaDto)
    {
        ...
        (matriculaDto.LaudoMedico?.Conteudo != null ? Arquivo.Criar(matriculaDto.LaudoMedico.Conteudo, ".jpg") : null! // Mapeia laudo do DTO para a entidade
        ));
    }
    public static Matricula UpdateFromDto(this Matricula matricula, MatriculaDTO matriculaDto)
    {
        ...
        (matriculaDto.LaudoMedico?.Conteudo != null ? Arquivo.Criar(matriculaDto.LaudoMedico.Conteudo, ".jpg") : matricula.LaudoMedico // Atualiza laudo se fornecido
        ));
    }
}