...
public static class ColaboradorMappings
{
    ...
    public static Colaborador ToEntity(this ColaboradorDTO colaboradorDto)
    {
        ...
        (colaboradorDto.Foto?.Conteudo != null) ? Arquivo.Criar(colaboradorDto.Foto.Conteudo, ".jpg") : null!, // Mapeia a foto do DTO para a entidade
    ...
    public static Colaborador UpdateFromDto(this Colaborador colaborador, ColaboradorDTO colaboradorDto)
    {
        ...
        (colaboradorDto.Foto?.Conteudo != null) ? Arquivo.Criar(colaboradorDto.Foto.Conteudo, ".jpg") : colaborador.Foto, // Atualiza a foto se fornecida
