...
namespace AcademiaDoZe.Infrastructure.Data
{
    public abstract class BaseRepository<TEntity> : IRepository<TEntity>, IAsyncDisposable where TEntity : Entity
    {
        ...
        protected virtual async Task<DbConnection> GetOpenConnectionAsync()
        {
            ...
            {
                // Vamos capturar a mensagem de erro real e todos os detalhes
                string mensagemDeErroReal = ex.Message; // Pega a mensagem principal do erro do SQL Server
                string detalhesCompletos = ex.ToString(); // Pega a mensagem completa, incluindo a "pilha de chamadas"

                // Agora, vamos lançar uma nova exceção contendo esses detalhes.
                // O código que chama este método e mostra o alerta na tela vai pegar esta mensagem.
                throw new InvalidOperationException($"Erro Detalhado: {mensagemDeErroReal}\n\nStackTrace: {detalhesCompletos}");
            }
        }
