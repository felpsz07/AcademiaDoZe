    ...
    public class ColaboradorRepository : BaseRepository<Colaborador>, IColaboradorRepository
    {
        ...
        public override async Task<Colaborador> Adicionar(Colaborador entity)
        {
            try
            {
                ...
                ? $"INSERT INTO {TableName} (cpf, telefone, nome, nascimento, email, logradouro_id, numero, complemento, senha, admissao, tipo, vinculo) "
                + "OUTPUT INSERTED.id_colaborador "
                + "VALUES (@Cpf, @Telefone, @Nome, @Nascimento, @Email, @LogradouroId, @Numero, @Complemento, @Senha, @Admissao, @Tipo, @Vinculo);"
                : $"INSERT INTO {TableName} (cpf, telefone, nome, nascimento, email, logradouro_id, numero, complemento, senha, admissao, tipo, vinculo) "
                + "VALUES (@Cpf, @Telefone, @Nome, @Nascimento, @Email, @LogradouroId, @Numero, @Complemento, @Senha, @Admissao, @Tipo, @Vinculo); "
